...
class Adm_Alw_Advance_Mdl extends Apppayroll_Frontmdl {
...
//            'gaji_pokok'     => 'right',
    ...
    public function fetch_all_alw_adv() {
...
//        $db = $this->load->database('default', true);
    ...
    public function get_rs_action() {
        ...
        $dl_title .= lang('Download Advance Allowance');
        $dl_title .= ' ';
        ...
        $im_title .= lang('Import Advance Allowance');
        $im_title .= ' ';
        ...
        $action   = array(
            ...
            'view_data' => array(
                ...
                'action_top'  => array(
                    'dl' => array(
                        'url'  => sprintf($r_url, md5('dl-alw_adv-tpl' . date('ymd'))),
                        'text' => $dl_title,
                    ),
                    'im' => array(
