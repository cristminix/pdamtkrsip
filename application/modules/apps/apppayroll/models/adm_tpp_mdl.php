...
class Adm_Tpp_Mdl extends Apppayroll_Frontmdl {

    public $payslip_mdl_inst     = 'payslip_mdl';
    public $tbl                  = 'apr_sv_payslip';
    public $tbl_app              = 'apr_adm_tpp';
    ...
    public function get_rs_action() {
        ...
        $action   = array(
            ...
            'view_data' => array(
                ...
                'action_top'  => array(
                    'dl' => array(
                        'url'  => sprintf($r_url, md5('dl-tpp-tpl' . date('ymd'))),
                        'text' => $dl_title,
                    ),
                    'im' => array(
