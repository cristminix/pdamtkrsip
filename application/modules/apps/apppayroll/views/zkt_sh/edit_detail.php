    ...
    <form class="form-horizontal" role="form" id="UserAddForm" method="post" accept-charset="utf-8">
        ...
        <fieldset>
            ...
            <div class="form-group">
                <label class="col-lg-2 col-sm-2 control-label"><a class="btn" href="<?php echo $rs_form_input['back_url'];?>"> <?php echo lang('back'); ?> <span class="fa fa-arrow-left"></span></a></label>
