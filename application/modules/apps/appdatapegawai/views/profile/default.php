...
<div class="row">
	<div class="col-lg-8">
        ...
        <button type="button" class="btn btn-primary btn-xs pull-right" onclick="$('a#aMyTabDrop1utama').click();" tabindex="-1" role="tab" data-toggle="tab" title="Edit Data Utama">
        ...
        <button type="button" class="btn btn-success btn-xs pull-right" onclick="$('a#aMyTabDrop2jabatan').click();"
	...
	<div class="col-lg-4">
        ...
        <button type="button" class="btn btn-success btn-xs pull-right" onclick="$('a#aMyTabDrop1foto').click();"
        ...
        <button type="button" class="btn btn-success btn-xs pull-right" onclick="$('a#aMyTabDrop2pangkat').click();"
        title="Riwayat Kepangkatan Pegawai">
