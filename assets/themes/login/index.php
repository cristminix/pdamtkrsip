...
<head>
	...
	<title><?php echo $nama_app; ?> | <?php echo $slogan_app; ?></title>
...
<div  style="background-color:#c8ecf8;" class="headertt">
	...
	<div class="container" style="width:100%;">
		<div class=row>
				<div class="col-lg-12">
					<div style="float:left;padding:10px 10px 10px 0px;"><img src="<?php echo base_url('assets/images/logo_in.png'); ?>"  style='width:80px; vertical-align:middle;'></div>
...
$hh['Sat'] = "Sabtu";
?>
		  <?php echo $hh[date('D')]; ?>, <?php echo date('d-m-Y'); ?></div>
...
<!--//header-->
    ...
    <div class="container" style = "width:100%" >
        <!-- <div class="row" style="background-image: url(assets/images/BACKGROUND.jpg);" > -->
            ...
            <div  class="col-md-4 col-md-offset-4" style="padding-top:20px; ">
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
						<form role="form" id="loginForm" accept-charset="utf-8" method="post" action="<?php echo site_url(); ?>login/dologin">
                            ...
                            <fieldset>
								...
								<div class="controls">
									<p><?php echo $gbr_captcha; ?></p>
									 <a href="<?php echo site_url(); ?>login/index">Refresh Capcha</a><br/>
									...
									<input type="hidden"  name="captcha_time" id="captcha_time" value="<?php echo $captcha_time; ?>">
								...
								<a href="<?php echo base_url(); ?>" class="btn btn-lg btn-info btn-block" name="Submit">Kembali Ke Dashboard</a>
                            </fieldset>
                        </form>
	...
	<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/plugins/metisMenu/metisMenu.min.js"></script>

    <!-- Custom Theme JavaScript -->
	<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/sb-admin-2.js"></script>


	<script type="text/javascript" src="<?php echo site_url(); ?>assets/js/jquery/jquery.form.js"></script>

<noscript>
<meta http-equiv="refresh" content="0; url=<?php echo site_url('enable_javascript'); ?>" />
</noscript>
...
<div>
      <footer>
		 <div style="padding:15px 0px 0px 15px; color:white;">
		   <div align="center">&copy; PDAM TKR Kabupaten Tangerang <?php echo date('Y'); ?></div>
		 </div>
...
<script type='text/javascript'>
 ...
 userpage =  {
			...
			var options = {
				...
				success : function(content) {
					...
					if(content.result == 'succes'){
						location.href = '<?php echo site_url(); ?>' + content.section;
	...
	auth:{
		init:function(){
			 if("<?php echo $sesi; ?>"){
					location.href = '<?php echo site_url(); ?>' + '<?php echo $sesi; ?>';
					jQuery('#button').hide();
			 }else{
			 	userpage.form.init();
			 }
...
// alert("a");
// function restoreDB(){
// alert("<?php echo site_url($com_url);?>login/refresh");
// jQuery("#content_restore").load("<?php echo site_url($com_url);?>login/refresh");

// $.ajax({
// type:"POST",
// url:"<?php echo site_url();?>login/refresh",
